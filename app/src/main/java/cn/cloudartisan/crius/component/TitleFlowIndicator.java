 ...
 * 
 */
public class TitleFlowIndicator extends TextView implements cn.cloudartisan.crius.component.FlowIndicator {
	...
	private cn.cloudartisan.crius.component.TitleProvider titleProvider = null;
	 ...
	 * (non-Javadoc)
	 * 
	 * @see cn.cloudartisan.crius.component.FlowIndicator#onScrolled(int, int, int,
	 * int)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * cn.cloudartisan.crius.component.ViewFlow.ViewSwitchListener#onSwitched(android
	 * .view.View, int)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * cn.cloudartisan.crius.component.FlowIndicator#setViewFlow(org.taptwo.android
	 * .widget.ViewFlow)
	 */
	@Override
	 ...
	 * @param provider
	 */
	public void setTitleProvider(cn.cloudartisan.crius.component.TitleProvider provider) {
