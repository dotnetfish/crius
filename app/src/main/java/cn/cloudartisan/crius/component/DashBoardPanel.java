...
public class DashBoardPanel extends ListView implements AdapterView.OnItemClickListener {
    ...
    public DashBoardPanel(Context paramContext, AttributeSet paramAttributeSet) {
    ...
    public void init(Context paramContext) {
        ...
        View header = LayoutInflater.from(paramContext).inflate(R.layout.layout_dashboard_panel, null);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        Friend friend=(Friend)list.get(position-1);
        intent.putExtra("othersId", friend.account);
        intent.putExtra("othersName", friend.name);
        context.startActivity(intent);
    }

    public void loadFriends(DashBoardPanel.LoadFriendListener listener) {
