...
public class LivesListAdapter extends BaseAdapter {
    ...
    public LivesListAdapter(Context c, List<ProductInfo> list) {
        context = c;
        this.list = list;
    ...
    public View getView(int index, View itemMessageView, ViewGroup parent) {
        ...
        if(itemMessageView == null) {
            ...
            viewHolder =(LivesListAdapter.ViewHolder) itemMessageView.getTag();
        }
