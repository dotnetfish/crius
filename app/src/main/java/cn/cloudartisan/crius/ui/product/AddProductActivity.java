...
public class AddProductActivity extends BaseActivity implements HttpAPIResponser, View.OnClickListener, TextWatcher {
    EditText keyword;
    ...
    public void initComponents() {
        ...
        findViewById(R.id.item_product).setOnClickListener(this);
        ...
        requester.execute(new TypeReference<AddProductActivity>() {
        }.getType(), null, URLConstant.getUrl("good","list"),"","GET");
    ...
    public void onClick(View v) {
        switch(v.getId()) {
            ...
            {
                requester.execute(new TypeReference<AddProductActivity>() {
                      }.getType(), null, URLConstant.getUrl("good","list"));
                break;
            }
            case R.id.item_user_account:
            {
                requester.execute(new TypeReference<AddProductActivity>() {}.getType(), null,  URLConstant.USER_DETAILED_URL);
                break;
            }
    ...
    public int getConentLayout() {
        return R.layout.activity_query_add_product;
    }
    
    public int getActionBarTitle() {
        return R.string.common_add_product_respository;
    }
