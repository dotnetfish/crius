...
public class MyCircleHomeActivity extends BaseActivity implements MyCircleLoadMoreListView.OnRefreshListener, HttpAPIResponser, AdapterView.OnItemClickListener {
    ...
    int currentPage=1;
    MyCircleHomeActivity.DeleteArticleReceiver deleteArticleReceiver;
    ...
    public void initComponents() {
        ...
        deleteArticleReceiver = new MyCircleHomeActivity.DeleteArticleReceiver();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch(item.getItemId()) {
            ...
            {
                Intent intent = new Intent(this, CircleMessageListActivity.class);
            ...
            extends BroadcastReceiver
    {
        ...
        public void onReceive(Context paramContext, Intent paramIntent)
        {
            ...
            MyCircleHomeActivity.this.list.remove(paramContext);
